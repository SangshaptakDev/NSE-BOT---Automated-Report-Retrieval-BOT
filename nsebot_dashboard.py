...
# Paths
log_file_path = r"C:\\NSE BOT MAIN\\NSE_TXT_LOG_ORG.txt"  # Log file path
script_path = r"C:\\NSE BOT MAIN\\NSE_BOT_REPORT_DOWNLOAD_MAIN_UPDATED.py"
download_folder = r"C:\\NSE BOT MAIN\\Downloaded Report"
